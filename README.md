...
Este tester evalúa exhaustivamente mi implementación de `get_next_line` utilizando la obra completa de *Don Quijote de la Mancha* como archivo de prueba. Lorem Ipsum está obsoleto.
